        ...
        <Flex direction={{ base: 'column', lg: 'row' }} gap={{ base: 8, lg: 12 }}>
          <Flex borderRadius="xl" flex="1">
            <Text color="gray.300" lineHeight={2}>
              With over 1 year of experience as a frontend developer and strong background in JavaScript, I have become
              a goal-driven and result-oriented software developer on a coding journey to acquire valuable skills so as
              to expand my horizon and make a difference in any project. I have a keen focus on developing creative and
              effective solutions that solve problems, while maintaining attention to design, accessibility, and
              well-structured code. I enjoy bringing ideas to reality and developing solutions that provide excellent
              user experiences.
            </Text>
          </Flex>
